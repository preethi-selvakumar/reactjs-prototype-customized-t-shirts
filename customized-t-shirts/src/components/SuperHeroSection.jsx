...
import { superHeroProducts } from '../data/superHeroProducts';
...
const SuperHeroSection = () => {
    ...
    const [productsToDisplay, setProductsToDisplay] = useState(superHeroProducts);
    ...
    useEffect(() => {
        ...
        if (searchTerm.trim() !== '') {
            // If there is a search term, filter and display superHeroProducts
            const searchedProducts = superHeroProducts.filter(product =>
            ...
            // If there's no search term, show superHeroProducts again
            setProductsToDisplay(superHeroProducts);
        }
    }, [searchTerm]);
        ...
        <>
            ...
            {productsToDisplay.length > 0 ? (
                ...
                <div className="no-products-message">
                    <p>
                        {searchTerm.trim() !== ''
                            ? "No Super Hero products found matching your search."
                            : "No Super Hero products available."}
                    </p>
                </div>
            )}
        </>
