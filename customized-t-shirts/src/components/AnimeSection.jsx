...
const AnimeSection = () => {
    ...
    const [productsToDisplay, setProductsToDisplay] = useState(animeProducts);
    ...
    useEffect(() => {
        ...
        if (searchTerm.trim() !== '') {
            // If there is a search term, filter and display animeProducts
            const searchedProducts = animeProducts.filter(product =>
            ...
            // If there's no search term, show animeProducts again
            setProductsToDisplay(animeProducts);
        }
    }, [searchTerm]);
        ...
        <>
            ...
            {productsToDisplay.length > 0 ? (
                ...
                <div className="no-products-message">
                    <p>
                        {searchTerm.trim() !== ''
                            ? "No Anime products found matching your search."
