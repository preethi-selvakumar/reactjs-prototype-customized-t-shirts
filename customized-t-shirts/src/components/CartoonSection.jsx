...
import { cartoonProducts } from '../data/cartoonProducts';
...
const CartoonSection = () => {
    ...
    const [productsToDisplay, setProductsToDisplay] = useState(cartoonProducts);
    ...
    useEffect(() => {
        ...
        if (searchTerm.trim() !== '') {
            // If there is a search term, filter and display cartoonProducts
            const searchedProducts = cartoonProducts.filter(product =>
            ...
            // If there's no search term, show cartoonProducts again
            setProductsToDisplay(cartoonProducts);
        }
    }, [searchTerm]);
        ...
        <>
            ...
            {productsToDisplay.length > 0 ? (
                ...
                <div className="no-products-message">
                    <p>
                        {searchTerm.trim() !== ''
                            ? "No Cartoon products found matching your search."
                            : "No Cartoon products available."}
                    </p>
                </div>
            )}
        </>
