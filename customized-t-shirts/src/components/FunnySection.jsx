...
import { funnyProducts } from '../data/funnyProducts';
...
const FunnySection = () => {
    ...
    const [productsToDisplay, setProductsToDisplay] = useState(funnyProducts);
    ...
    useEffect(() => {
        ...
        if (searchTerm.trim() !== '') {
            // If there is a search term, filter and display funnyProducts
            const searchedProducts = funnyProducts.filter(product =>
            ...
            // If there's no search term, show funnyProducts again
            setProductsToDisplay(funnyProducts);
        }
    }, [searchTerm]);
        ...
        <>
            ...
            {productsToDisplay.length > 0 ? (
                ...
                <div className="no-products-message">
                    <p>
                        {searchTerm.trim() !== ''
                            ? "No Funny products found matching your search."
                            : "No Funny products available."}
                    </p>
                </div>
            )}
        </>
